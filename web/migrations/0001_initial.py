    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_sample', models.ManyToManyField(blank=True, to='web.EnvironmentalSample')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lysate', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='web.Lysate')),
            ],
        ),
        migrations.CreateModel(
            name='SampleType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.SequencingRun')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pool', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.SequencingRunPool')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='lysate',
            name='phage',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='web.Phage'),
        ),
        migrations.AddField(
            model_name='lysate',
            name='source',
