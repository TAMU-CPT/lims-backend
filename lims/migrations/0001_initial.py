# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-12-07 21:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phage', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lims.Phage')),
            ],
        ),
        migrations.CreateModel(
            name='SampleType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tube', models.CharField(max_length=64)),
                ('tube_type', models.CharField(max_length=64)),
            ],
        ),
        migrations.AddField(
            model_name='phagednaprep',
            name='storage',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lims.Storage'),
        ),
        migrations.AddField(
            model_name='lysate',
            name='phage',
