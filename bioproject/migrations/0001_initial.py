...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.IntegerField(choices=[(0, 'Viewer'), (1, 'Editor'), (2, 'Administrator'), (3, 'Owner')], default=0)),
        ...
        migrations.AddField(
            model_name='bioproject',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner', to='bioproject.EditingRoleUser'),
        ),
        migrations.AddField(
            model_name='bioproject',
            name='sample',
